<template>
  <div class="app-container">
          ...
          >
            ...
            >
              ...
              <el-form-item label="品牌占比" prop="brandProportion">
                <el-input
                  v-model.number="item.brandProportion"
                  placeholder="请输入占比"
                  readonly
                >
            ...
            <el-row type="flex" :gutter="20">
              <el-col :span="10" class="form-table">
                ...
                <el-table :data="item.categoryList">
                  <el-table-column property="categoryName" label="覆盖品类">
                  </el-table-column>
                  <el-table-column property="priceSection" label="价格带">
                  </el-table-column>
                </el-table>
              </el-col>
              <el-col :span="14" class="form-table">
                ...
                <el-table :data="item.supplierList" highlight-current-row>
                  ...
                  ><el-table-column property="shareProportion" label="份额占比">
                  </el-table-column>
                </el-table>
              </el-col>
            </el-row>
    ...
    <el-row :gutter="20" style="margin-top: 30px; flex-wrap: wrap">
      <el-col
        class="visitCard"
        v-for="(item, index) in visitDetailVoList"
        :key="index"
      >
        <el-card>
